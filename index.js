...
function fusionarArreglo(objetoNuevo, objetoActual) {
  ...
  objetoNuevo.forEach(function (_objetoNuevo) {
    ...
    if (indice < 0) {
      ...
      if (typeof _objetoNuevo == "object" && _objetoNuevo != null) {
        objetoFinal.push(fusionarObjeto(_objetoNuevo, objetoActual[indice]));
...
function fusionarObjeto(objetoNuevo, objetoActual) {
  var objetoFinal = objetoActual;
...
console.log("hola que hace " + JSON.stringify(fusionarObjeto(body, persona)));
